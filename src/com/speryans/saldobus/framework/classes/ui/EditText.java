...
public class EditText extends BasicEditField {
	private String hint;
	...
	public EditText(String text, String hint, int q, long style) {
		super(text, "", q, style);
	...
	protected void paint(Graphics g) {
		...
		try {
			if (getText().equals("")) {
				...
				g.setColor(0xCCCCCC);
				g.drawText(hint, 4, (getHeight() / 2 ) - 1 , DrawStyle.VCENTER); // + _buttonFont.getHeight() / 4
			} else {
				super.paint(g);
			}
		} finally {
