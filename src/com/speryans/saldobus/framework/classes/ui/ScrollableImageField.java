...
public class ScrollableImageField extends BitmapField
{
    ...
    {    
        super(theImage, BitmapField.FOCUSABLE | BitmapField.FIELD_HCENTER );
    ...
    protected void paint(Graphics graphics)
    {
        ...
        XYRect rect = new XYRect(0,0, Display.getWidth(), Display.getHeight());//this.getManager().getContentRect();        
    ...
    protected void drawFocus(Graphics graphics, boolean on)
    {
        if (on)
        {
        	...
        	XYRect rect = new XYRect(0,0, Display.getWidth(), Display.getHeight());
    ...
    protected boolean touchEvent(TouchEvent touchEvent)
    {
    	...
    	else if (event == TouchEvent.MOVE && touchEvent.isValid())
    	{
			...
			boolean result = scrollImage( (touchEvent.getX(1) - _xTouch) * -1 , (touchEvent.getY(1) - _yTouch) * -1 );
