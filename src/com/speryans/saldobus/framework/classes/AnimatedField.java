...
public class AnimatedField extends BitmapField 
{
    ...
    public AnimatedField(GIFEncodedImage image)
    {
        this(image, 0);
    }
    
    public AnimatedField(GIFEncodedImage image, long style)
    {
    ...
    {
        private AnimatedField _theField;
        ...
        public AnimatorThread(AnimatedField theField)
        {
            _theField = theField;
