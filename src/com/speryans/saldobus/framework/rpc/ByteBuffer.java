package com.speryans.saldobus.framework.rpc;


import java.io.*;

import com.speryans.saldobus.framework.rpc.codec.base64.*;
import com.speryans.saldobus.framework.rpc.json.me.*;
...
public ByteBuffer(String s) throws IllegalArgumentException {
  if( s == null || s.equalsIgnoreCase("") ) {
	  throw new IllegalArgumentException("ByteBuffer constructor - string can not be null or empty.");
  }
...
public static ByteBuffer fromBase64EncodedString(String serform) throws Base64FormatException, IOException {
	...
	if( serform == null || serform.equalsIgnoreCase("") ) {
		  throw new Base64FormatException("Base64Encoded String can not be null or empty.");
	  }
...
public void addToJSON(JSONObject object, String key) throws IOException, JSONException {
  if( key == null || key.equalsIgnoreCase("") ) {
	  throw new JSONException("ByteBuffer - key for json object can't be empty");
  }
  
  if( object == null || object.length() == 0 ) {
	  throw new JSONException("ByteBuffer - json object can't be empty");
  }
